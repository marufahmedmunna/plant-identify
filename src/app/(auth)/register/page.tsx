    ...
    <Card className="w-full max-w-sm">
        ...
        <form onSubmit={handleRegister} className="grid gap-4">
          <div className="grid gap-2">
            ...
            <Input id="full-name" placeholder="Enter your full name" required value={fullName} onChange={(e) => setFullName(e.target.value)} disabled={isLoading || isGoogleLoading}/>
          </div>
          <div className="grid gap-2">
          ...
          <Button type="submit"   className="w-full bg-secondary hover:bg-green-600 text-black" disabled={isLoading || isGoogleLoading}>
